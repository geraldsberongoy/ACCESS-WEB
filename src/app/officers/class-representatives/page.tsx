...
import { ClassRepresentativesView } from "@/features/officers";
...
export default async function ClassRepresentativesPage() {
  noStore();
  const classReps = await getClassRepresentativesContent();
      ...
      <div className="relative z-10 flex flex-col min-h-screen pt-24 md:pt-28">
        <main className="flex-1 py-8 px-4 sm:px-6 md:px-12 lg:px-16 relative">
          <div className="w-full max-w-7xl mx-auto">
            <ClassRepresentativesView initialYearLevels={classReps} />
          </div>
        </main>
