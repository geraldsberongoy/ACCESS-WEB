...
The landing page (`app/page.tsx`) is the public entry point of the ACCESS Web Portal. It is a **single full-viewport hero section** that introduces the organization to visitors.
...
public/
└── BG-ACCESS.png                   # Hero background photo
```
...
|---------|---------|---------|
| 0 | `BG-ACCESS.png` (`<Image fill />`) | Full-cover background photo |
...
### `components/ui/FloatingBlocks.tsx`
